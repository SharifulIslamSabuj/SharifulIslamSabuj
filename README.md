...
*Building scalable automation frameworks, API testing solutions, and CI/CD-driven quality engineering for enterprise software.*
...
**Automation** &nbsp;·&nbsp; Selenium WebDriver · Cucumber BDD · TestNG · Page Object Model · Parallel Execution · Thread-Safe Driver Management

**API Testing** &nbsp;·&nbsp; REST Assured · Postman · POJO Modeling · Token Authentication · E2E Workflow Validation
...
**Programming** &nbsp;·&nbsp; Java 17 · OOP · Design Patterns (Builder, Singleton, Factory) · SQL

**Quality Process** &nbsp;·&nbsp; Test Strategy · UAT Leadership · Defect Management · CMMI Level 5 · ISO 9001 · Agile/Scrum
...
### [API Automation Framework — Grocery Store](https://github.com/SharifulIslamSabuj/api-automation-framework)

![Java](https://img.shields.io/badge/Java-17-007396?logo=openjdk&logoColor=white)
&nbsp;
![REST Assured](https://img.shields.io/badge/REST_Assured-6-49CC90?style=flat)
&nbsp;
...
- Designed and built Selenium + Java automation frameworks; automated 80+ critical regression scenarios
...
- Drove ISO 9001 and CMMI Level 5 QA governance; reduced defect leakage by 30%
...
*M.Sc. &nbsp;·&nbsp; B.Sc. in Computer Science & Engineering — University of Rajshahi*
